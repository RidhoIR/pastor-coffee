                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-5">
                                            <input class="form-control" type="number" id="harga_produk"
                                                name="harga_produk" min="1000" max="1000000">
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                    ...
                    <tbody>
                        @foreach ($produks as $produk)
                            ...
                            <tr data-bs-toggle="modal">
                                <td>{{ $produk->id }}</td>
                                <td><img src="{{ asset('/storage/images/' . $produk->gambar_produk) }}"
                                ...
                                <td>
                                    <form action="/admin/produk/delete/{{ $produk->id }}" method="post">
                                        @csrf
                                        <button type="sumbit" name="deleteProduk"
                                            style="border: none; background-color: #EED6C4;">
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#staticBackdrop-{{ $produk->id }}">
                                        Update
                                    </button>
                                </td>

                                <div class="modal fade" id="staticBackdrop-{{ $produk->id }}"
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <label for="staticEmail"
                                                            class="col-sm-5 col-form-label">Product Price</label>
                                                        <div class="col-sm-5">
                                                            <input type="number" value="{{ $produk->harga_produk }}"
